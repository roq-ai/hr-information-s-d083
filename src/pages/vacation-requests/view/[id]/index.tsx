...
import { getVacationRequestById } from 'apiSdk/vacation-requests';
...
function VacationRequestViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Vacation Request Detail View
          </Text>
          {hasAccess('vacation_request', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/vacation-requests/edit/${data?.id}`} passHref legacyBehavior>
              <Button
