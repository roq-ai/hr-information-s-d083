...
import { getCustomerRequestById } from 'apiSdk/customer-requests';
...
function CustomerRequestViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('customer_request', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/customer-requests/edit/${data?.id}`} passHref legacyBehavior>
              <Button
